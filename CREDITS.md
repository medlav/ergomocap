...
| PySide6                       | 6.6.3.1      | GNU Library or Lesser General Public License (LGPL); Other/Proprietary License |
| PySide6_Addons                | 6.6.3.1      | GNU Library or Lesser General Public License (LGPL); Other/Proprietary License |
| PySide6_Essentials            | 6.6.3.1      | GNU Library or Lesser General Public License (LGPL); Other/Proprietary License |
...
| coverage-badge                | 1.1.2        | MIT License                                                                    |
| cycler                        | 0.12.1       | BSD License                                                                    |
| debugpy                       | 1.8.20       | MIT License                                                                    |
| decorator                     | 5.3.1        | BSD-2-Clause                                                                   |
| deffcode                      | 0.2.6        | Apache Software License                                                        |
| docstring_parser_fork         | 0.0.14       | MIT License                                                                    |
...
| jax                           | 0.6.1        | Apache-2.0                                                                     |
| jaxlib                        | 0.6.1        | Apache-2.0                                                                     |
...
| mediapipe                     | 0.10.14      | Apache Software License                                                        |
...
| setproctitle                  | 1.3.3        | BSD License                                                                    |
| shiboken6                     | 6.6.3.1      | GNU Library or Lesser General Public License (LGPL); Other/Proprietary License |
| six                           | 1.17.0       | MIT License                                                                    |
| skelly_synchronize            | 2025.4.1037  | GNU Affero General Public License v3 or later (AGPLv3+)                        |
| skelly_viewer                 | 2025.4.1028  | GNU Affero General Public License v3 or later (AGPLv3+)                        |
| skellycam                     | 2025.9.1097  | GNU Affero General Public License v3 or later (AGPLv3+)                        |
| skellyforge                   | 2024.12.1009 | GNU Affero General Public License v3 or later (AGPLv3+)                        |
| skellytracker                 | 2025.10.1024 | GNU Affero General Public License v3 or later (AGPLv3+)                        |
